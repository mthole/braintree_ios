...
class BTLocalPayment_UnitTests: XCTestCase {
    ...
    // TODO: We removed check for a valid `returnURLScheme` in LocalPaymentRequest.
    // Do we still need a test to cover the fact that our SDK is hard coding the scheme
    // or does that just not really apply b/c of the transition to ASWeb?
...
//    }
    ...
    func testStartPayment_postsAllCreationParameters() {
        ...
        // TODO: Pretty sure we can delete this test
